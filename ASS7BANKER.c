...
dityagawas@adityagawas-VirtualBox:~$ gcc banker.c -o banker 
adityagawas@adityagawas-VirtualBox:~$ ./banker
...
Enter the details of process P4: 
	Enter the allocates resources: 0 2 2
	Enter the max resourcess: 4 3 3

Enter the allvailable resources: 3 3 2
	...
	SYSTEM IS IN SAFE STATE...
safesequence is: P1 -> P3 -> P4 -> P0 -> P2 -> adityagawas@adityagawas-VirtualBox:~$ 
