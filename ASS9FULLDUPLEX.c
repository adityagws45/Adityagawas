...
dityagawas@adityagawas-VirtualBox:~$ gcc priya.c -o priya
adityagawas@adityagawas-VirtualBox:~$ ./priya
IN PARENT PROCESS

Enter name of file:ramesh
Filename is being sent by Parent Process to Child Process through Pipe 1...


Contents of ramesh are being received by Parent Process through Pipe 2...

IN PARENT PROCESS

Received Message:

Filename 'ramesh' is being read by Child Process through Pipe 1...

Contents of ramesh are being sent to Parent Process through Pipe 2...
